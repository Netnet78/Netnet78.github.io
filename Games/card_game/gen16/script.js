document.addEventListener("DOMContentLoaded", function () {
  ...
  function analyzeAudio(audioElement) {
    ...
    function checkBeat() {
      ...
      if (average > 99) {
        // Adjust this threshold based on your audio
  ...
  function createCardPairs() {
    ...
    const selectedImages = imageNames.slice(0, 29);
  ...
  function createBoard() {
    ...
    cards.forEach((imageName) => {
      ...
      card.style.backgroundImage = `url('../images/GEN16/${imageName}.png')`;
  ...
  function createStarFall() {
    ...
    for (let i = 0; i < numberOfStarsFall; i++) {
      ...
      starFall.style.backgroundImage =
